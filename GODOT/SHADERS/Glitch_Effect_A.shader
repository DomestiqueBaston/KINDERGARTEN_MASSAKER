...
uniform float brightness : hint_range(0.0, 10.0) = 1.13; // When adding scanline gaps and grille the image can get very dark. Brightness tries to compensate for that.
...
//	}
	...
	// float saturation = 0.5; retrait perso
	// float contrast = 1.2; retrait perso
	// uniform float saturation : hint_range(0.0,1.0) = 0.5; // ajout perso
	// uniform float contrast : hint_range(0.0,5.0) = 1.2; // ajout perso
	if (discolor)
	{
		// Saturation
