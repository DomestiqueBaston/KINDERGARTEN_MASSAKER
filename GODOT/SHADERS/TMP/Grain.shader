...
uniform float color_amount :hint_range(0, 1.3) = 0.0;
uniform float grain_amount :hint_range(0, 0.07) = 0.004; //grain amount
uniform float grain_size :hint_range(1, 3) = 1.5; //grain particle size (1.5 - 2.5)
uniform float lum_amount :hint_range(0, 2) = 1.5;
