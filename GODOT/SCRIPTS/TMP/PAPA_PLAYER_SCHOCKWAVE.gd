...
func start_timers():
	if cooldown_ready:
		...
		$PLAYER/Schockwave_Front.visible = true
		$PLAYER/Schockwave_Back.visible = true
		$PLAYER/AnimationPlayer.play("schockwave")
		...
		$PLAYER/Schockwave_Front.visible = false
		$PLAYER/Schockwave_Back.visible = false
